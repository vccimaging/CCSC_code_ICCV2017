function [ d_res, z_res, DZ, iterations ] = admm_learn_conv2D_large(b, kernel_size, ...
    ...
    for i = 1:max_it              
        ...
        for nn=1:N
            ...
            [zhat_mat{nn}, zhat_inv_mat{nn}] = precompute_H_hat_D(zup{nn}, size_z_crop, 500); %gammas_D(2)/gammas_D(1)
        end
        t_kernel = toc;
        ...
        for i_d = 1:max_it_d
            ...
            for nn = 1:N
                ...
                dup{nn} = solve_conv_term_D(zhat_mat{nn}, zhat_inv_mat{nn}, ud_D{nn}, Bh{nn}, 500, size_z_crop);
